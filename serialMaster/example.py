...
if __name__ == '__main__':
    try:
        ...
        # Befehle an den Petoi-Roboter senden
        command = 'ksit'
        robot_socket.send(command.encode())
        # Weitere Befehle senden und den Roboter steuern...
        # Verbinduna trennen
       # robot_socket.close()
        ...
        testSchedule = [
            ...
            ['b',
             [14, 8, 14, 8, 21, 8, 21, 8, 23, 8, 23, 8, 21, 4, 19, 8, 19, 8, 18, 8, 18, 8, 16, 8, 16, 8, 14, 4, 21, 8,
              21, 8, 19, 8, 19, 8, 18, 8, 18, 8, 16, 4, 21, 8, 21, 8, 19, 8, 19, 8, 18, 8, 18, 8, 16, 4, 14, 8, 14, 8,
              21, 8, 21, 8, 23, 8, 23, 8, 21, 4, 19, 8, 19, 8, 18, 8, 18, 8, 16, 8, 16, 8, 14, 4], 0],
            # will make the next skill break if it has 0
